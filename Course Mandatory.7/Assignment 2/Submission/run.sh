#!/bin/bash
# Housing Loan Setup Script

# Constants
VENV_NAME=".venv"
NOTEBOOK_FILENAME="House_Loan_Data_Analysis.ipynb"
LOG_FILE="setup_log.txt"
KERNEL_NAME="housing-loan-env"

# Initialize log file
echo "--- Housing Loan Setup Log $(date) ---" > "$LOG_FILE"
...
echo ""
echo "================================================================================"
echo "========== Housing Loan Setup & Run Script ==========="
echo "================================================================================"
echo ""
...
"$VENV_PYTHON" -m ipykernel install --user --name="$KERNEL_NAME" --display-name="Python (Housing Loan)" >> "$LOG_FILE" 2>&1
if [[ $? -ne 0 ]]; then
...
DATASET_PATHS=(
  ...
  "${SCRIPT_DIR}/../../Datasets_October/House_Loan_Data_Analysis_dataset/loan_data.csv"
  "${SCRIPT_DIR}/../Datasets_October/House_Loan_Data_Analysis_dataset/loan_data.csv"
...
export HOUSING_LOAN_DATASET="$DATASET_PATH"
log "Set environment variable HOUSING_LOAN_DATASET=$DATASET_PATH"
...
log "Starting Jupyter with Housing Loan kernel..."
